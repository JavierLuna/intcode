...
@pytest.mark.parametrize("program,input,expected_output", [("3,9,8,9,10,9,4,9,99,-1,8", 8, 1),
                                                           ("3,9,8,9,10,9,4,9,99,-1,8", 9, 0),
                                                           ("3,3,1108,-1,8,3,4,3,99", 8, 1),
                                                           ("3,3,1108,-1,8,3,4,3,99", 9, 0)])
def test_day_5_equals(program, input, expected_output):
    stack_io_handler = StackIOHandler([str(input)])
    machine = IntCodeMachine(program, io_handler=stack_io_handler)
    machine.run()
    assert stack_io_handler.io_stack == [str(expected_output)]
...
@pytest.mark.parametrize("program,input,expected_output", [("3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9", 0, 0),
...
@pytest.mark.parametrize("input,expected_output", [(7, 999),
                                                   (8, 1000),
                                                   (9, 1001)])
